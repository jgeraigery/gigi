...
VSOutput vsmain(VSInput input)
{
    ...
    if (/*$(Variable:FlipUVY)*/)
    {
        ret.UV0.y = 1.0f - ret.UV0.y;
        ret.UV1.y = 1.0f - ret.UV1.y;
        ret.UV2.y = 1.0f - ret.UV2.y;
        ret.UV3.y = 1.0f - ret.UV3.y;
    }
    ...
    switch(/*$(Variable:ViewMode)*/)
    {
        ...
        case ViewModes::Tangent:
        {
            ...
            break;
        case ViewModes::UV0: ret.Color = float4(ret.UV0, 0.0f, 1.0f); break;
        case ViewModes::UV1: ret.Color = float4(ret.UV1, 0.0f, 1.0f); break;
        case ViewModes::UV2: ret.Color = float4(ret.UV2, 0.0f, 1.0f); break;
        case ViewModes::UV3: ret.Color = float4(ret.UV3, 0.0f, 1.0f); break;
